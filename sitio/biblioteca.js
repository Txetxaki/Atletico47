...
var LIB={
 /* ---- rodilla dominante ---- */
 sent_banco:{n:"Sentadilla a banco con mancuernas",pat:"rodilla",req:["banco"],tipo:"mancuerna",inc:1,r:[8,10],s:3,ini:5,zona:"pierna",evita:[],alt:["wall_sit","ext_term"],nivel:1,musculos:["cuadriceps","gluteos"],
 ...
 wall_sit:{n:"Sentadilla isométrica en pared",pat:"rodilla",req:[],tipo:"corporal",inc:0,r:[20,40],s:3,seg:1,zona:"pierna",evita:[],alt:["ext_term"],nivel:1,musculos:["cuadriceps"],
 ...
 ext_term:{n:"Extensión terminal de rodilla con banda",pat:"rodilla",req:["banda"],tipo:"banda",inc:0,r:[15,20],s:2,zona:"pierna",evita:[],alt:["wall_sit"],nivel:1,musculos:["cuadriceps"],
 ...
 /* ---- unilateral ---- */
 step_up:{n:"Step-up a escalón bajo",pat:"unilateral",req:["escalon"],tipo:"mancuerna",inc:1,r:[10,10],s:2,ini:0,zona:"pierna",evita:["rodD","rodI"],alt:["ext_term"],nivel:1,musculos:["cuadriceps","gluteos"],
 ...
 zancada_inv:{n:"Zancada inversa",pat:"unilateral",req:[],tipo:"mancuerna",inc:1,r:[8,10],s:2,ini:0,zona:"pierna",evita:["rodD","rodI","cadera"],alt:["step_up"],nivel:3,musculos:["cuadriceps","gluteos"],
 ...
 /* ---- bisagra y glúteo ---- */
 pm_rumano_m:{n:"Peso muerto rumano con mancuernas",pat:"bisagra",req:[],tipo:"mancuerna",inc:1,r:[10,12],s:3,ini:5,zona:"pierna",evita:["cadera"],alt:["puente"],nivel:1,musculos:["isquios","gluteos"],
 ...
 puente_isq:{n:"Puente de isquios con talones en el banco",pat:"bisagra",req:["banco"],tipo:"corporal",inc:0,r:[10,15],s:3,zona:"pierna",evita:[],alt:["pm_rumano_m"],nivel:1,musculos:["isquios","gluteos"],
  q:"puente isquiotibiales talones banco tecnica",
  c:"Tumbado boca arriba, talones sobre el banco y rodillas algo flexionadas. Clava los talones y sube la cadera hasta alinear hombros, cadera y rodillas. Baja en 2 segundos.",
  b:"Exhala al subir.",
  e:"Isquios sin carga en la columna ni flexión de cadera: la cadera se mueve en extensión, que es el rango cómodo con artrosis."},
 buenos_dias_b:{n:"Buenos días con banda",pat:"bisagra",req:["banda"],tipo:"banda",inc:0,r:[12,15],s:3,zona:"pierna",evita:[],alt:["pm_rumano_m"],nivel:1,musculos:["isquios","gluteos"],
  q:"good morning banda elastica tecnica",
  c:"Banda bajo los pies y por detrás del cuello o sobre los hombros. Rodillas algo flexionadas, cadera hacia atrás con la espalda recta y sube apretando glúteos. Solo hasta donde la pelvis siga neutra.",
  b:"Exhala al subir.",
  e:"La misma bisagra que el rumano pero sin peso en las manos: la muñeca no trabaja y la carga crece solo al final del recorrido."},
 puente:{n:"Puente de glúteo → hip thrust",pat:"gluteo",req:[],tipo:"mancuerna",inc:2,r:[12,15],s:3,ini:0,zona:"pierna",evita:[],alt:["pm_rumano_m"],nivel:1,musculos:["gluteos","isquios"],
 ...
 swing:{n:"Swing con kettlebell",pat:"bisagra",req:["kb"],tipo:"kb",inc:2,r:[10,12],s:3,zona:"pierna",evita:["munI","cadera"],alt:["pm_rumano_m"],nivel:3,musculos:["gluteos","isquios"],
 ...
 /* ---- cadera lateral ---- */
 abd_banda:{n:"Abducción de cadera con banda",pat:"cadera_lat",req:["banda"],tipo:"banda",inc:0,r:[15,20],s:2,zona:"pierna",evita:[],alt:["almeja"],nivel:1,musculos:["gluteos"],
 ...
 almeja:{n:"Almeja tumbado de lado",pat:"cadera_lat",req:[],tipo:"banda",inc:0,r:[15,20],s:2,zona:"pierna",evita:[],alt:["abd_banda"],nivel:1,musculos:["gluteos"],
 ...
 /* ---- empuje horizontal ---- */
 press_manc_n:{n:"Press banca con mancuernas, agarre neutro",pat:"emp_hor",req:["banco"],tipo:"mancuerna",inc:1,r:[10,12],s:3,ini:5,zona:"superior",evita:["hombI"],alt:["flex_nud"],nivel:1,musculos:["pecho","hombros","triceps"],
 ...
 flex_nud:{n:"Flexiones de nudillos",pat:"emp_hor",req:[],tipo:"corporal",inc:0,r:[8,12],s:3,zona:"superior",evita:["hombI"],alt:["press_manc_n"],nivel:1,musculos:["pecho","hombros","triceps"],
 ...
 /* ---- tracción horizontal ---- */
 remo_manc:{n:"Remo a una mano con mancuerna",pat:"trac_hor",req:["banco"],tipo:"mancuerna",inc:1,r:[10,12],s:3,ini:5,zona:"superior",evita:[],alt:["remo_trx"],nivel:1,musculos:["espalda","biceps"],
 ...
 remo_trx:{n:"Remo invertido en TRX",pat:"trac_hor",req:["trx"],tipo:"corporal",inc:0,r:[10,12],s:3,zona:"superior",evita:[],alt:["remo_manc"],nivel:1,musculos:["espalda","biceps"],
 ...
 /* ---- tracción vertical ---- */
 colgarse:{n:"Colgarse de la barra",pat:"trac_ver",req:["torre"],tipo:"corporal",inc:0,r:[15,30],s:3,seg:1,zona:"superior",evita:["hombI"],alt:["remo_trx"],nivel:1,musculos:["espalda","antebrazo"],
 ...
 dom_neg:{n:"Dominadas negativas",pat:"trac_ver",req:["torre"],tipo:"corporal",inc:0,r:[3,5],s:3,zona:"superior",evita:["hombI"],alt:["colgarse"],nivel:2,musculos:["espalda","biceps"],
 ...
 press_mil_n:{n:"Press militar sentado, agarre neutro",pat:"emp_ver",req:["banco"],tipo:"mancuerna",inc:1,r:[10,12],s:3,ini:5,zona:"superior",evita:["hombI"],alt:["elev_lat"],nivel:1,musculos:["hombros","triceps"],
 ...
 elev_lat:{n:"Elevaciones laterales",pat:"hombro",req:[],tipo:"mancuerna",inc:1,r:[12,15],s:2,ini:2,zona:"superior",evita:[],alt:["face_pull"],nivel:1,musculos:["hombros"],
 ...
 face_pull:{n:"Face pull con banda",pat:"hombro",req:["banda"],tipo:"banda",inc:0,r:[15,20],s:2,zona:"superior",evita:[],alt:["elev_lat"],nivel:1,musculos:["hombros","espalda"],
 ...
 /* ---- transporte ---- */
 granjero:{n:"Paseo del granjero",pat:"carry",req:[],tipo:"mancuerna",inc:2,r:[30,40],s:3,seg:1,ini:10,zona:"superior",evita:[],alt:["plancha_ant"],nivel:1,musculos:["antebrazo","core"],
 ...
 exc_mun:{n:"Extensión excéntrica de muñeca derecha",pat:"antebrazo",req:[],tipo:"mancuerna",inc:0.5,r:[15,15],s:3,ini:2,zona:"superior",evita:["codoD"],alt:[],nivel:1,musculos:["antebrazo"],
 ...
 /* ---- core ---- */
 plancha_ant:{n:"Plancha de antebrazos",pat:"core",req:[],tipo:"corporal",inc:0,r:[30,45],s:3,seg:1,zona:"core",evita:[],alt:["dead_bug"],nivel:1,musculos:["core"],
 ...
 plancha_lat:{n:"Plancha lateral en antebrazo",pat:"core",req:[],tipo:"corporal",inc:0,r:[20,30],s:2,seg:1,zona:"core",evita:["hombI"],alt:["dead_bug"],nivel:1,musculos:["core"],
 ...
 dead_bug:{n:"Dead bug",pat:"core",req:[],tipo:"corporal",inc:0,r:[10,12],s:2,zona:"core",evita:[],alt:["plancha_ant"],nivel:1,musculos:["core"],
 ...
 pallof:{n:"Press Pallof con banda",pat:"core",req:["banda"],tipo:"banda",inc:0,r:[10,12],s:2,zona:"core",evita:[],alt:["dead_bug"],nivel:1,musculos:["core"],
...
/* Vocabulario de grupos musculares en español. Cada ejercicio de LIB lleva 'musculos'
   (primario primero); los ejercicios propios lo heredan por patrón si no se eligen a mano. */
var MUSC={cuadriceps:"Cuádriceps",gluteos:"Glúteos",isquios:"Isquiotibiales",pecho:"Pecho",espalda:"Espalda",hombros:"Hombros",biceps:"Bíceps",triceps:"Tríceps",core:"Core",gemelos:"Gemelos",antebrazo:"Antebrazo / agarre",movilidad:"Movilidad"};
var MUSC_POR_PAT={rodilla:["cuadriceps"],unilateral:["cuadriceps","gluteos"],bisagra:["isquios","gluteos"],gluteo:["gluteos","isquios"],cadera_lat:["gluteos"],emp_hor:["pecho","hombros","triceps"],emp_ver:["hombros","triceps"],trac_hor:["espalda","biceps"],trac_ver:["espalda","biceps"],hombro:["hombros"],carry:["antebrazo","core"],antebrazo:["antebrazo"],core:["core"]};
